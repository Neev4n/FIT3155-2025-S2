...
def boyer_moore_algorithm(text: str, pattern: str):
    ...
    while k < t:
        ...
        while k1 < p and text[k-k1] == pattern[p - 1 - k1]:
            t1 = text[k - k1]
            p1 = pattern[p - 1 - k1]
        ...
        bad_char_val = bad_char_table[p - k1 - 1][ord(text[k-k1]) - ord('a')]
        bad_char_shift = p if bad_char_val == -1 else max(1, p - bad_char_val - k1 - 1)
